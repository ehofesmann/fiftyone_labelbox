...
class LabelboxBackendConfig(foua.AnnotationBackendConfig):
    ...
    Args:
        ...
        classes_as_attrs (True): whether to show every object class at the top
            ...
            each object (True)
        upload_media (False): whether to download cloud media to your local
...
class LabelboxAnnotationAPI(foua.AnnotationAPI):
    ...
    def upload_data(self, samples, lb_dataset, media_field="filepath", upload_media=False):
    ...
    def upload_samples(self, samples, anno_key, backend):
        ...
        self.upload_data(samples, dataset, media_field=media_field, upload_media=upload_media)
